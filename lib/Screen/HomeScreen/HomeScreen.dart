...
class _HomeScreenState extends State<HomeScreen> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      GridView(
                        ...
                        children: [
                          cardWidget(Images.EXPENSE_HOME, "14", txtExpenses, 70.0),
  ...
  cardWidget(image, count, type, height) {
    return Container(
      padding: EdgeInsets.all(20),
      height: 30,
      decoration: BoxDecoration(
    ...
    content: Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              TextButton(onPressed: () {}, child: txtNotNow.text.lg.makeCentered()),
              Container(
                color: grey,
              ),
              TextButton(
                onPressed: () {},
                child: txtNotNow.text.lg.makeCentered(),
              ),
            ],
          )
        ],
